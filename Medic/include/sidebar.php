...
<body>
  ...
  <div class="sidebar collapsed" id="sidebar">
    ...
    <ul class="menu">
      ...
      <a href="index.php">
        <li data-label="Sa lagro lalala ka!" style="list-style-type: none;">
          <img src="../include/Lagro_High_School_logo.png" alt="" width="50px" style="margin-left: -14px;"><span>LHS Clinic</span>
        </li>
      </a>

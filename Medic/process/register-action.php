...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['register'])) {
        ...
        $sql = "INSERT INTO registered_accounts (registrant_img, first_name, middle_name, last_name, employee_id, mobile_num, account_pass, role)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("sssssiss", $registrant_img, $first_name, $middle_name, $last_name, $employee_id, $mobile_num, $account_pass, $role);

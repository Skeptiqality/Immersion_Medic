...
$allowedLinks = isset($rolePermissions[$userRole]) ? $rolePermissions[$userRole] : [];

// Function to check if link should be shown
function canViewLink($linkName, $allowedLinks) {
    return in_array($linkName, $allowedLinks);
}
...
<body>
  ...
  <div class="sidebar collapsed" id="sidebar">
    <ul class="menu">
      ...
      <?php if (canViewLink('dashboard', $allowedLinks)): ?>
      <a href="dashboard.php">
        <li data-label="Dashboard"><i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
              <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z" />
            </svg></i><span>Dashboard</span></li>
      </a>
      <?php endif; ?>
      <?php if (canViewLink('index', $allowedLinks)): ?>
      <a href="index.php">
        <li data-label="Add Patient"><i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
              <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
              <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4" />
            </svg></i><span>Add Patient</span></li>
      </a>
      <?php endif; ?>
      <?php if (canViewLink('confine', $allowedLinks)): ?>
      <a href="confine.php">
        <li data-label="Confinement Form"><i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-book" viewBox="0 0 16 16">
              <path d="M1 2.828c.885-.37 2.154-.769 3.388-.893 1.33-.134 2.458.063 3.112.752v9.746c-.935-.53-2.12-.603-3.213-.493-1.18.12-2.37.461-3.287.811zm7.5-.141c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783" />
            </svg></i><span>Confinement Form</span></li>
      </a>
      <?php endif; ?>
      <?php if (canViewLink('studentlist', $allowedLinks)): ?>
      ...
      <?php endif; ?>
      <?php if (canViewLink('anecdotal', $allowedLinks)): ?>
      ...
      <?php endif; ?>
      <?php if (canViewLink('reports', $allowedLinks)): ?>
      <a href="reports.php">
        <li data-label="Reports"><i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-flag" viewBox="0 0 16 16">
            ...
            </svg></i><span>Reports</span></li>
      </a>
<<<<<<< HEAD
      <a href="display.php">
        <li data-label="Enrolled Students"><i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard" viewBox="0 0 16 16">
        <path d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1z"/>
        <path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0z"/>
        </svg></i><span>Enrolled Students</span></li>
      </a>
=======
      <?php endif; ?>
      <?php if (canViewLink('history', $allowedLinks)): ?>
      <a href="history.php">
        <li data-label="History"><i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock-history" viewBox="0 0 16 16">
            ...
            </svg></i><span>History</span></li>
      </a>
      <?php endif; ?>
>>>>>>> 78862c229a9bae1cecc75f95b02a2266a5dae6ce
